	...
	bot.on('message', (message) => {
		...
		//se for eu ping
		if(message.author.id == "200240729103007744" && message.content == "!ping") {
			message.sendMessage('Pong? Ta tudo funcionando, esquizofrênico do caralho...');
		}
		
		//BR
		if(message.author.id == "200240729103007744" && message.content == "!kampff2049") {
		...
		if(message.author.id == "200240729103007744" && message.content == "!kampff2019") {
